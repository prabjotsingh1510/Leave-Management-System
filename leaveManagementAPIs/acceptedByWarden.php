    ...
    if ($auth_data['success']) {
        ...
        if (isset($post_data->id)) {
            ...
            $stmt = $pdo->prepare("UPDATE weekend_applications 
                                   ...
                                   WHERE id = :id AND status = 'MApproved'");
            ...
            if ($result && $stmt->rowCount() > 0) {
                ...
                $fetch_stmt = $pdo->prepare("SELECT * FROM weekend_applications WHERE id = :id");
                ...
                if ($leave_details) {
                    // Compose the email
                    $to = "harsh.22bce9029@vitapstudent.ac.in";
                    ...
                    try {
                        ...
                        $mail->Password = 'gpui jycr vreo jlcr'; // Your Gmail password or app-specific password
